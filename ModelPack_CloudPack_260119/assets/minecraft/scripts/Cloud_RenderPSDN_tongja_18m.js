...
function render(entity, pass, par3, color){
   ...
   //수치 알아서 조절하십시오.
    ...
    var doorMoveDistanceA = 1.006; //ドアの長さ(m)
...
function renderSignboard(entity)
{
			...
			if(0 <= footime && footime<=1000) {
				msg01.render(renderer); 
			} 
			else if(1000 < footime && footime <= 2000) {
				msg02.render(renderer);
			}
						else if(2000 < footime && footime <= 3000) {
				msg03.render(renderer); 
			}
						else if(3000 < footime && footime <= 4000) {
				msg04.render(renderer);
			}
						else if(4000 < footime && footime <= 5000) {
				msg05.render(renderer); 
			}
			else if(5000 < footime && footime <= 6000) {
				msg06.render(renderer); 
			}
			else if(6000 < footime && footime <= 7000) {
