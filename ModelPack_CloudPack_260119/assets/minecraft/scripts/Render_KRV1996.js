...
function init(par1, par2)
{
	...
	base = renderer.registerParts(new Parts("badak", "side_1", "doorside_1", "jibung", "cheonjang", "back", "aircon", "seat", "redseat", "habu", "obj1", "obj2", "jibungmakdaegi", "seonban", "seonban_redseat", "inled", "sideled", "front", "sk", "driverdoor", "light", "front_in", "driverwall", "ledroom", "bbul", "pan_base", "pan_side"));
	/*
